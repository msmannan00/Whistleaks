...
public class OrbotService extends VpnService implements OrbotConstants {
    ...
    public void newIdentity() {
        ...
        new Thread() {
            public void run() {
                try {
                    if (conn != null && mCurrentStatus.equals(STATUS_ON)) {
                        orbotLocalConstants.mTorCountry = "Masked ...";
                        orbotLocalConstants.mTorIP = "Masked ...";
    ...
    public void onInvokeController(int pCommand){
        try {
            Intent intent;
            intent = new Intent(this, Class.forName("com.hiddenservices.dtechservices.appManager.orbotRequestManager"));
