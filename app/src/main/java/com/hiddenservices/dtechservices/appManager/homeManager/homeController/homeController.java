package com.hiddenservices.dtechservices.appManager.homeManager.homeController;
...
import com.hiddenservices.dtechservices.appManager.homeManager.geckoManager.helperClasses.permissionHandler;
import com.hiddenservices.dtechservices.appManager.bookmarkManager.bookmarkSettings.bookmarkSettingController;
import com.hiddenservices.dtechservices.appManager.bookmarkManager.bookmarkHome.bookmarkController;
import com.hiddenservices.dtechservices.appManager.editTextManager;
import com.hiddenservices.dtechservices.appManager.historyManager.historyController;
import com.hiddenservices.dtechservices.appManager.homeManager.profiler.profilerManager;
import com.hiddenservices.dtechservices.appManager.unproxiedConnectionManager.unproxiedConnectionController;
import com.hiddenservices.dtechservices.dataManager.models.historyRowModel;
import com.hiddenservices.dtechservices.appManager.homeManager.geckoManager.geckoView;
import com.hiddenservices.dtechservices.appManager.homeManager.geckoManager.*;
import com.hiddenservices.dtechservices.appManager.homeManager.geckoManager.geckoSession;
import com.hiddenservices.dtechservices.appManager.homeManager.hintManager.hintAdapter;
import com.hiddenservices.dtechservices.appManager.languageManager.languageController;
import com.hiddenservices.dtechservices.appManager.orbotLogManager.orbotLogController;
import com.hiddenservices.dtechservices.appManager.orbotManager.orbotController;
import com.hiddenservices.dtechservices.appManager.settingManager.searchEngineManager.settingSearchController;
import com.hiddenservices.dtechservices.appManager.settingManager.settingHomeManager.settingHomeController;
import com.hiddenservices.dtechservices.dataManager.models.tabRowModel;
...
import com.hiddenservices.dtechservices.libs.views.KeyboardUtils;
import com.hiddenservices.dtechservices.appManager.activityStateManager;
...
import com.hiddenservices.dtechservices.pluginManager.pluginReciever.defaultNotificationReciever;
...
import static com.hiddenservices.dtechservices.appManager.homeManager.homeController.homeEnums.eHomeViewCallback.M_NEW_LINK_ANIMATION;
import static com.hiddenservices.dtechservices.appManager.homeManager.homeController.homeEnums.eHomeViewCallback.OPEN_NEW_TAB;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_BADCERT_CACHED;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_BADCERT_CACHED_DARK;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_ERROR_CACHED;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_ERROR_CACHED_DARK;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_HELP_URL_CACHE;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_HELP_URL_CACHE_DARK;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_URL_CACHED;
import static com.hiddenservices.dtechservices.constants.constants.CONST_GENESIS_URL_CACHED_DARK;
import static com.hiddenservices.dtechservices.constants.constants.CONST_PRIVACY_POLICY_URL_NON_TOR;
import static com.hiddenservices.dtechservices.constants.keys.M_ACTIVITY_RESPONSE;
import static com.hiddenservices.dtechservices.constants.responses.BOOKMARK_SETTING_CONTROLLER_SHOW_DELETE_ALERT;
import static com.hiddenservices.dtechservices.constants.responses.BOOKMARK_SETTING_CONTROLLER_SHOW_SUCCESS_ALERT;
import static com.hiddenservices.dtechservices.constants.sql.SQL_CLEAR_HISTORY;
import static com.hiddenservices.dtechservices.dataManager.dataEnums.eBookmarkCommands.M_INTENT_BOOKMARK;
...
public class homeController extends AppCompatActivity implements ComponentCallbacks2 {
    ...
    private profilerManager mProfilerManager;
    ...
    private LinearLayout mTopBarContainerWhistle;
    ...
    private ImageButton mWhisperTor;
    private ImageButton mWhisperIdentity;
    private ImageButton mMenu;
    private NestedScrollView mNestedScroll;
    private ImageView mBlockerFullSceen;
    private ImageView mNewTabBlocker;
    private TextView mCopyright;
    private TextView mWhistleCountry;
    private TextView mWhistleIP;
    private TextView mWhistleBusinessCode;
    ...
    public void bindWhistleStatus(){
        new Thread(){
            public void run(){
                while (true){
                    try {
                        runOnUiThread(() -> {
                            if(!status.sDefaultTor){
                                String mCountry = "not connected";
                                String mIP = "not connected";
                                String mCode = "BCODE - ";
                                if(status.sBusinessCode.length()==6 && !status.sBusinessCodeLogin.equals("")){
                                    mCode = mCode + status.sBusinessCode;
                                }else{
                                    mCode = mCode + "UNKNOWN";
                                }

                                mWhistleCountry.setText(mCountry);
                                mWhistleIP.setText(mIP);
                                mWhistleBusinessCode.setText(mCode);
                            }else {
                                mWhistleCountry.setText(orbotLocalConstants.mTorCountry);
                                mWhistleIP.setText(orbotLocalConstants.mTorIP);
                                String mCode = "BCODE - ";
    ...
    public void toggleBrowserMode(){
        ...
        mHomeViewController.onNewTabAnimation(null, null, 7000, mGeckoClient.getSession().getCurrentURL());
        mGeckoClient.getSession().close();
        onCloseAllTabs();

        dataController.getInstance().invokeTab(dataEnums.eTabCommands.M_CLEAR_TAB, null);
        activityContextManager.getInstance().getTabController().onCloseAllTabs();
        status.mWhistleMode = !status.mWhistleMode;
        mHomeViewController.onToggleWhistleMode();

        //mHomeViewController.onProgressBarUpdate(5, isStaticURL());
        ...
        mSearchbar.setText(status.sSettingDefaultSearchEngine);

        if(status.mWhistleMode){
            mHomeViewController.triggerUpdateSearchBar(mProfilerManager.getHomeURL(), false, true, true);
            onLoadURL(helperMethod.getDomainName(mProfilerManager.getHomeURL()));
        }else {
            mHomeViewController.triggerUpdateSearchBar(status.sSettingDefaultSearchEngine, false, true, true);
            onLoadURL(helperMethod.getDomainName(status.sSettingDefaultSearchEngine));
        }

        mHomeViewController.onProgressBarUpdate(mGeckoClient.getSession().getProgress(), isStaticURL());
    }
    ...
    public void initializeConnections() {
        ...
        mTopBarContainerWhistle = findViewById(R.id.pTopBarContainerWhistle);

        mWhistleCountry = findViewById(R.id.pWhisperCountry);
        mWhistleIP = findViewById(R.id.pWhisperIP);
        mWhistleBusinessCode = findViewById(R.id.pWhisperCode);
        mProfilerManager = new profilerManager(this);
        mWhisperTor = findViewById(R.id.pWhisperTor);
        mWhisperIdentity = findViewById(R.id.pWhisperIdentity);
    ...
    public void onLoadTab(geckoSession mTempSession, boolean isSessionClosed, boolean pExpandAppBar, boolean pForced, boolean pGeneratePixel) {
        ...
        if (!mTempSession.isOpen()) {
            ...
            mHomeViewController.onProgressBarUpdate(mTempSession.getProgress(), isStaticURL());
        }else {
    ...
    public void onHomeButton(View view) {
        if(!status.mThemeApplying){
            String mURL = status.sSettingDefaultSearchEngine;
            if(status.mWhistleMode){
                mURL = status.sBusinessCodeURL;
            }
            if(mGeckoClient.getSession()!=null){
                mGeckoClient.getSession().setTheme(null);
                mHomeViewController.onUpdateStatusBarTheme(mGeckoClient.getTheme(), true);
                onLoadURL(helperMethod.getHost(mURL));
                mHomeViewController.onUpdateSearchBar(mURL, false, false, false);
            }
        }
    }
    ...
    public void onNotificationInvoked(String message, homeEnums.eHomeViewCallback e_type) {
        mHomeViewController.downloadNotification(message);
    }
    ...
    public void onConfigurationChanged(@NonNull Configuration newConfig) {
        ...
        mHomeViewController.expandTopBar(false, mGeckoView.getMaxY());
        status.sUIInteracted = true;
        if(status.sBusinessCode.equals("")){
            initBusinessCode();
        }
    }
    ...
    public void initBusinessCode(){
        if(!status.mThemeApplying){
            pluginController.getInstance().onMessageManagerInvoke(Collections.singletonList(this), M_BUSINESS_CODE);
        }else{
            mHomeViewController.splashScreenDisableInstant();
            if(!status.sBusinessCode.equals("")){
                initBuinessCode(status.sBusinessCode);
            }
            if(!status.mWhistleMode){
                mHomeViewController.onToggleWhistleMode();
            }
    ...
    public boolean initBuinessCode(String pCode) {
        boolean mBusinessCodeResult = mProfilerManager.initJSON(this, pCode);
        if(mBusinessCodeResult){
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);
        }
        if(mBusinessCodeResult && !status.sDefaultTor){
            onStartApplicationNoTor(null);
            //mHomeViewController.splashScreenDisableInstant();
        }
        return mBusinessCodeResult;
    }
        ...
        if (mGeckoView != null) {
            ...
            if (model != null) {
                ...
                if (mGeckoView != null && mGeckoView.getSession() != null && !mGeckoView.getSession().isOpen()) {
                    ...
                    mHomeViewController.triggerUpdateSearchBar(mGeckoClient.getSession().getCurrentURL(), false, true, true);
                    super.onResume();
                }
            }
        }
    ...
    public void onStartApplicationNoTor(View view) {
        ...
        mHomeViewController.onNewTabAnimation(Collections.singletonList(mGeckoClient.getSession()), homeEnums.eGeckoCallback.NULL, 500, "");
        status.sTorBrowsing = false;
        status.sNoTorTriggered = true;
        mGeckoClient.initRuntimeSettings(homeController.this);
        if(status.sSettingDefaultSearchEngine.equals(constants.CONST_BACKEND_GENESIS_URL)){
    ...
    public void onMenuItemInvoked(View view) {
        ...
        if (menuId == R.id.menu11) {
        ...
        else if (menuId == R.id.menu29 || menuId == R.id.pWhisperTor) {
            ...
            } else if (menuId == R.id.menu28 || menuId == R.id.pWhisperIdentity) {
                onNewCircuitInvoked();
            ...
            } else if (menuId == R.id.pMenuQuit || menuId == R.id.pWhisperQuit) {
                mGeckoClient.onMediaInvoke(enums.MediaController.DESTROY);
                pluginController.getInstance().onOrbotInvoke(Collections.singletonList(status.mThemeApplying), pluginEnums.eOrbotManager.M_DESTROY);
                onHideDefaultNotification();
                finishAndRemoveTask();
            ...
            if (menuId == R.id.menu31) {
                mGeckoClient.getSession().stop();
                onLoadURL(mProfilerManager.getLoginURL());
            }
            if (menuId == R.id.menu21) {
                ...
                if (mUrl.equals(constants.CONST_GENESIS_HELP_URL_CACHE_DARK) && status.sTheme != enums.Theme.THEME_DARK) {
                    ...
                    mGeckoClient.getSession().reload();
                }
            ...
            if (menuId == R.id.menu24 || menuId == R.id.pWhisperHome) {
                helperMethod.hideKeyboard(this);
                onHomeButton(view);
            }
    ...
    public class homeViewCallback implements eventObserver.eventListener {
        ...
        public Object invokeObserver(List<Object> data, Object e_type) {
            ...
            if (e_type.equals(homeEnums.eHomeViewCallback.M_GET_SSL_STATUS)) {
                ...
                mHomeViewController.onProgressBarUpdate(100, false);
            ...
            else if (e_type.equals(homeEnums.eHomeViewCallback.ON_URL_LOAD_START)) {
                onHomeButton(null);
            }
    ...
    public class geckoViewCallback implements eventObserver.eventListener {
        ...
        public Object invokeObserver(List<Object> data, Object e_type) {
            ...
            if (e_type.equals(homeEnums.eGeckoCallback.M_ON_SCROLL_BOUNDARIES)) {
                ...
                mHomeViewController.onProgressBarUpdate((int) data.get(0), isStaticURL());
