package com.hiddenservices.dtechservices.pluginManager;
...
import com.hiddenservices.dtechservices.appManager.homeManager.homeController.homeController;
...
import com.hiddenservices.dtechservices.pluginManager.downloadPluginManager.downloadManager;
import com.hiddenservices.dtechservices.pluginManager.langPluginManager.langManager;
import com.hiddenservices.dtechservices.pluginManager.messagePluginManager.messageManager;
import com.hiddenservices.dtechservices.pluginManager.orbotPluginManager.orbotManager;
import java.lang.ref.WeakReference;
import java.util.Arrays;
import java.util.Collections;
import java.util.List;
import java.util.Locale;
import static com.hiddenservices.dtechservices.constants.constants.CONST_BRIDGES;
import static com.hiddenservices.dtechservices.pluginManager.pluginEnums.eLangManager.M_ACTIVITY_CREATED;
import static com.hiddenservices.dtechservices.pluginManager.pluginEnums.eLangManager.M_RESUME;
...
public class pluginController {
    ...
    private class messageCallback implements eventObserver.eventListener {
        ...
        public Object invokeObserver(List<Object> pData, Object pEventType) {
            ...
            } else if (pEventType.equals(M_BUSINESS_CODE_SUBMIT)) {
                return ((homeController) mHomeController.get()).initBuinessCode(pData.get(0).toString());
            }
