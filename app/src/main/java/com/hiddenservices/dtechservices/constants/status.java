package com.hiddenservices.dtechservices.constants;
...
public class status {
    ...
    public static String sBusinessCode = "";
    public static String sBusinessCodeURL = "";
    public static String sBusinessCodeLogin = "";
    ...
    public static boolean sProxyChanging = false;
    public static boolean sDefaultTor = false;
    ...
    public static boolean mWhistleMode = true;
    ...
    public static void initStatus(Context pContext, boolean reinit) {
        ...
        status.sDefaultTor = (boolean) dataController.getInstance().invokePrefs(dataEnums.ePreferencesCommands.M_GET_BOOL, Arrays.asList(keys.SETTING_TOR_BROWSING_DEFAULT, true));
        ...
        if (!reinit && !status.sNoTorTriggered){
            ...
            status.sSettingDefaultSearchEngine = (String) dataController.getInstance().invokePrefs(dataEnums.ePreferencesCommands.M_GET_STRING, Arrays.asList(keys.SETTING_SEARCH_ENGINE, constants.CONST_BACKEND_DUCK_DUCK_GO_URL));
        }
