package com.hiddenservices.dtechservices.libs.providers;
...
public class CookieContentProvider extends ContentProvider {
    ...
    private static final String AUTH = "org.torproject.android.ui.hiddenservices.providers.dtechservices.cookie";
