...
package com.hiddenservices.dtechservices.libs.netcipher.web;
...
//            worked = setWebkitProxyGingerbread(ctx, host, port);
    ...
    private static boolean setWebkitProxyLollipop(Context appContext, String host, int port) {
        ...
        try {
            ...
            Log.d("ProxySettings", "Exception setting WebKit proxy on Lollipop through ProxyChangeListener: " + e);
        } catch (NoSuchFieldException e) {
            Log.d("ProxySettings", "Exception setting WebKit proxy on Lollipop through ProxyChangeListener: " + e);
        } catch (IllegalAccessException e) {
            Log.d("ProxySettings", "Exception setting WebKit proxy on Lollipop through ProxyChangeListener: " + e);
