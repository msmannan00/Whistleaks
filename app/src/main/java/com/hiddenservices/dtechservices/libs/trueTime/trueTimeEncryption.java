package com.hiddenservices.dtechservices.libs.trueTime;
...
public class trueTimeEncryption {
    ...
    public String getSecretToken() throws UnsupportedEncodingException {
        ...
        com.hiddenservices.dtechservices.libs.fernet.Key mKey = new com.hiddenservices.dtechservices.libs.fernet.Key(android.util.Base64.encodeToString(S_FERNET_KEY.getBytes(), android.util.Base64.DEFAULT).replace("\n", ""));
        com.hiddenservices.dtechservices.libs.fernet.Token mToken = com.hiddenservices.dtechservices.libs.fernet.Token.generate(mKey, S_APP_BLOCK_KEY + "----" + mTime);
