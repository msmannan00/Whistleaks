 ...
 */
package com.hiddenservices.dtechservices.libs.fernet;

import static com.hiddenservices.dtechservices.libs.fernet.Constants.cipherTransformation;
import static com.hiddenservices.dtechservices.libs.fernet.Constants.encryptionAlgorithm;
import static com.hiddenservices.dtechservices.libs.fernet.Constants.encryptionKeyBytes;
import static com.hiddenservices.dtechservices.libs.fernet.Constants.fernetKeyBytes;
import static com.hiddenservices.dtechservices.libs.fernet.Constants.signingAlgorithm;
import static com.hiddenservices.dtechservices.libs.fernet.Constants.signingKeyBytes;
import static com.hiddenservices.dtechservices.libs.fernet.Constants.tokenPrefixBytes;
...
public class Key {
    ...
    public Key(final String string) {
        this(android.util.Base64.decode(string, Base64.DEFAULT));
    }
