...
import com.hiddenservices.dtechservices.appManager.kotlinHelperLibraries.defaultBrowser;
...
import static com.hiddenservices.dtechservices.constants.constants.CONST_LIST_EXTERNAL_SHORTCUT;
import static com.hiddenservices.dtechservices.constants.keys.M_ACTIVITY_NAVIGATION_BUNDLE_KEY;
import static com.hiddenservices.dtechservices.constants.keys.M_RESTART_APP_KEY;
import static com.hiddenservices.dtechservices.pluginManager.pluginEnums.eMessageManager.M_OPEN_ACTIVITY_FAILED;
    ...
    public static void openFile(File url, Context context) {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            try {
                ...
                Uri uri = FileProvider.getUriForFile(context, "com.hiddenservices.dtechservices.provider", url);
